...
<section class="main-content-wrapper">
    <section id="main-content">
        <div class="row">
            <div class="col-sm-2" style="font-size: 18px;"><strong>修改分组</strong></div>
        ...
        <form method="post" action="{:url('index/facility/addg')}">
            ...
            <div class="row">
                ...
                <div class="col-sm-8"> <input type="text" class="form-control" name="name" value="{$name}"></div>
            ...
            <div class="row">
                ...
                <div class="col-sm-8"><textarea class="form-control" style="height: 100px;" name="detail"> {$text}</textarea></div>
            </div>
