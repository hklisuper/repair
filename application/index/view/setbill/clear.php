            ...
            <ul>
                <li class="dropdown messages">
                    ...
                    <ul class="dropdown-menu alert animated fadeInDown">
                        ...
                        <li>
                            <a href="#">
                                <div class="profile-photo">
                                    <img src="/img/avatar.gif" alt="" class="img-circle">
                                </div>
                        ...
                        <li>
                            <a href="#">
                                <div class="profile-photo">
                                    <img src="/img/avatar1.gif" alt="" class="img-circle">
                                </div>
                                <div class="message-info">
                        ...
                        <li>
                            <a href="#">
                                <div class="profile-photo">
                                    <img src="/img/avatar2.gif" alt="" class="img-circle">
                                </div>
                                <div class="message-info">
                        ...
                        <li>
                            <a href="#">
                                <div class="profile-photo">
                                    <img src="/img/avatar3.gif" alt="" class="img-circle">
                                </div>
                                <div class="message-info">
                        ...
                        <li>
                            <a href="#">
                                <div class="profile-photo">
                                    <img src="/img/avatar4.gif" alt="" class="img-circle">
                                </div>
                                <div class="message-info">
                ...
                <li class="dropdown settings">
                    ...
                    <ul class="dropdown-menu animated fadeInDown">
                        ...
                        <li>
                            <a href="{:url('index/index/logout')}"><i class="fa fa-power-off"></i> Logout</a>
                        </li>
                    </ul>
                </li>
                <li>
...
<section class="main-content-wrapper">
    <section id="main-content">
        ...
        <div class="row">
            <div class="col-md-4">
                <input type="date" id="start" value="2015-09-24"/>到 <input type="date"  id="end" value="2015-09-24"/>
                <br><br>
                <button class="btn btn-lg btn-primary" onclick="search()">查找</button>
            </div>
        </div>
