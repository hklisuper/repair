    ...
    {include file="public/nav" /}
       ...
       <hr style="height:1px;border:none;border-top:1px solid #555555;" />
           <div class="panel-body">
               <form role="form" method="post" action="{:url('index/user/update')}">                              
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-1" style="text-align: right;"><label for="exampleInputEmail1">昵称</label></div>
                                            <div class="col-md-11"> <input type="text" class="form-control" name="name" value="{$row.name}"></div>
                                        </div>      
                                    </div>
                                  <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-1" style="text-align: right;"><label for="exampleInputEmail1">账号</label></div>
                                            <div class="col-md-11"> <input type="text" class="form-control" name="account" value="{$row.account}"></div>
                                        </div>      
                                    </div>
                                    <div class="form-group">
                                       <div class="row">
                                            <div class="col-md-1" style="text-align: right;"><label for="exampleInputEmail1">电话</label></div>
                                            <div class="col-md-11"> <input type="text" class="form-control" name="mobile"  value="{$row.mobile}"></div>
                                        </div>    
                                    </div>
                                   <div class="form-group">
                                       <div class="row">
                                           <div class="col-md-1" style="text-align: right;"><label for="exampleInputEmail1">地址</label></div>
                                           <div class="col-md-11"> <input type="text" id="input2" class="form-control" name="address" readonly ></div>
                                       </div>
                                   </div>
                                   <div class="form-group">
                                           <div class="row">
                                               <div class="col-md-1" style="text-align: right;"><label for="exampleInputEmail1">详细地址</label></div>
                                               <div class="col-md-11"> <input type="text" class="form-control" name="daddr" value="{$row.daddr}" ></div>
                                           </div>
                                   </div>
...
//                alert("234");
               ...
               geocoder.getAddress(e.lnglat,function(status,result){
                   if(status=='complete'){
                       document.getElementById('input2').value = result.regeocode.formattedAddress;
                   }
               })
           })
