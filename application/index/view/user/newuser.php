...
<!--                   <button class="btn btn-success" onclick="goback()" style="float: right;">返回</button>-->
                   <a href="{:url('index/user/index')}"  class="btn btn-success" style="text-decoration: none;color: #fff;"> 返回</a>
               </div>
           </div>
                ...
                <form role="form" method="post" action="{:url('index/user/adduser')}">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-11"> <input type="text"  class="form-control" name="address_detail"  ></div>
                        </div>
                    </div>
