   {include file="public/header" /}
       ...
       <hr style="height:1px;border:none;border-top:1px solid #555555;" />
           <div class="panel-body">
               <form role="form" method="post" action="{:url('index/section/updateman')}">                              
                                    ...
                                    <div class="form-group">
                                       <div class="row">
                                            <div class="col-md-1" style="text-align: right;"><label for="exampleInputEmail1">职务</label></div>
                                            <div class="col-md-11"> <input type="text" class="form-control" name="duty"  value="{$row.status}"></div>
                                        </div>    
                                    </div>
                                    <div class="form-group">
                                       <div class="row">
                                            <div class="col-md-1" style="text-align: right;"><label for="exampleInputEmail1">范围</label></div>
                                            <div class="col-md-11"> <input type="text" class="form-control" name="scope" value="{$row.scope}" ></div>
                                        </div>    
                                    </div>   
