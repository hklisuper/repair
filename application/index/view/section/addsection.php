            ...
            <section id="main-content">
                <div class="row">
                    ...
                    <div class="col-md-10" style="text-align: right;">
                        <a href="{:url('index/section/index')}"  class="btn btn-success" style="text-decoration: none;color: #fff;"> 返回</a>
                    </div>
                </div>
       <hr style="height:1px;border:none;border-top:1px solid #555555;" />
           <div class="panel-body">
               <form role="form" method="post" action="{:url('index/section/add')}">                              
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-1" style="text-align: right;"><label for="exampleInputEmail1">名称</label></div>
                                            <div class="col-md-11"> <input type="text" class="form-control" name="Gname"></div>
                                        </div>      
                                    </div>
                                    <div class="form-group">
                                       <div class="row">
                                            <div class="col-md-1" style="text-align: right;"><label for="exampleInputEmail1">备注</label></div>
                                            <div class="col-md-11"> <input type="text" class="form-control" name="remark" ></div>
                                        </div>    
                                    </div>
                                    <div class="form-group">
                                       <div class="row">
                                            <div class="col-md-1" style="text-align: right;"><label for="exampleInputEmail1">负责人</label></div>
                                            <div class="col-md-11"> <input type="text" class="form-control" name="charge" ></div>
                                        </div>    
                                    </div>     
